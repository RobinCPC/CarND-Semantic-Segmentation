...
def load_vgg(sess, vgg_path):
    ...
    c3_tensor = graph.get_tensor_by_name(vgg_layer3_out_tensor_name)
    c4_tensor = graph.get_tensor_by_name(vgg_layer4_out_tensor_name)
    c7_tensor = graph.get_tensor_by_name(vgg_layer7_out_tensor_name)

    return input_tensor, keep_tensor, c3_tensor, c4_tensor, c7_tensor
